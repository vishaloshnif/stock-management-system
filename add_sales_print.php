      ...
      <tr>
		...
		echo $phpdate;
			  ?> <br />
                <br />
                <strong><br />
                &nbsp;&nbsp;&nbsp;Receipt No: <?php echo $sid;?> </strong><br /></td>
              <td width="33%"><div align="center"> <br />
                  <strong>Oshnif Technologies Pvt.Ltd </strong><br />
                  Shop-No.f-119,Pushp Enclave, <br />
                  Pratap Nagar Sanganer,Jaipur<br />
                  Pin - 302 029<br />
              </div></td>
            </tr>
          </table></td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <?php 
				...
				$line2 = $db->queryUniqueObject("SELECT customer_name ,customer_address ,customer_contact1,customer_contact2 FROM customer_details WHERE customer_name='$cname' ");
				
				echo "Address:".$line2->customer_address ."<br />";
				?>
				
				<?php
				echo "Contact No: ".$line2->customer_contact1."<br>";
				echo "Contact No: ".$line2->customer_contact2."<br>";
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="22%" bgcolor="#CCCCCC"><strong>Product Name</strong></td>
...
?>
	...
	$tax_percent=$line3->tax_percent;
	$tax_amount=$line3->tax_amount;
	...
	$mysqldate=$line->due;	
	  ...
	  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="18%" bgcolor="#CCCCCC"><?php echo $total; ?>&nbsp;</td>
        </tr>
        <tr>
          <td width="82%" align="right" bgcolor="#CCCCCC"><strong>Tax(<?php echo $tax_percent;?>%)&nbsp;&nbsp;</strong></td>
          <td width="18%" bgcolor="#CCCCCC"> <?php echo $tax_amount; ?>&nbsp;</td>
        </tr>
        <tr>
          <td width="82%" align="right" bgcolor="#CCCCCC"><strong>Grand Total&nbsp;&nbsp;</strong></td>
